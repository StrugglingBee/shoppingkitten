...
<%--添加商品的弹窗--%>
<div id="product_alert" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-group" id="product_form">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">售价</span> <input type="number"
                                                                         class="form-control" name="productsale_price">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">进价</span> <input type="number"
                                                                         class="form-control" name="product_price">
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon">库存</span> <input type="number"
                                                                         class="form-control" name="product_stock">
                    </div>
